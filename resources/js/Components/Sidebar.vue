...
<template>
    <fwb-sidebar class="top-auto p-3 rounded-lg relative min-h-full">
        <fwb-sidebar-item>
            <template #icon>
                <svg
        ...
        <fwb-sidebar-item>
            ...
            <template #default>Productos</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
            ...
            <template #default>Ventas</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
            ...
            <template #default>Compras</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
            ...
            <template #default>Gastos</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
                ...
                >
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 13h3.4a1 1 0 0 1 1 .6 4 4 0 0 0 7.3 0 1 1 0 0 1 .9-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9M9 7h6m-7 3h8"/>
                </svg>
            </template>
            <template #default>Inventario</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
            ...
            <template #default>Reportes</template>
        </fwb-sidebar-item>
        <fwb-sidebar-item>
            <template #icon>
                <svg
            ...
            <template #default>Configuracion</template>
        </fwb-sidebar-item>
    </fwb-sidebar>
</template>
